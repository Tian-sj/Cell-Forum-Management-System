...
<html>
	...
	<body style="background-color: #f1f1f1">
		<div class="kele">
			<a href="PropertyMain.jsp?ss=<%="" %>&username=<%=request.getParameter("username") %>">返回</a>
		</div>
		<div id="main">
			...
			<div style="background-image:url('images/form.jpg');">
				<form action="PostsShow_P.bin" method="post" onsubmit="return Check();">
					<input type="hidden" name = "username" value=<%=request.getParameter("username") %>>
					<input type="hidden" name = "user" value="物业">
